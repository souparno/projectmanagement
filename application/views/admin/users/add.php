      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          ...
          echo '<div class="alert alert-error">';
            echo '<a class="close" data-dismiss="alert">×</a>';
            echo '<strong>Oh snap!</strong> new user could not be created.';
          echo '</div>';          
        }
      }
      ?>
      ...
      ?>
        <fieldset>
            <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="" name="u_name" value="<?php echo set_value('u_name'); ?>" >
            ...
            <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="" name="f_name" value="<?php echo set_value('f_name'); ?>" >
                          <!--<span class="help-inline">Woohoo!</span>-->
                        </div>
                      </div>
            <div class="control-group">
                        ...
                        <div class="controls">
                          <input type="text" id="" name="l_name" value="<?php echo set_value('l_name'); ?>" >
                          <!--<span class="help-inline">Woohoo!</span>-->
                        </div>
                      </div>

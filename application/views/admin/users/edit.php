<div class="container top">
    ...
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="" name="user_name" value="<?php echo $user[0]['username']; ?>" >
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" id="" name="password" value="<?php echo $user[0]['password']; ?>" >
                <!--<span class="help-inline">Woohoo!</span>-->
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="" name="email" value="<?php echo $user[0]['email']; ?>" >
                <!--<span class="help-inline">Woohoo!</span>-->
            </div>
        </div>
